...
This app is desingned to calculate customer life time value and show insights into transactional data using the BG/NBD Model detailed in [“Counting Your Customers” the Easy Way: An Alternative to the Pareto/NBD Model"](http://brucehardie.com/papers/018/fader_et_al_mksc_05.pdf)

## Usage

To use this webapp, first input the connection parameters to your remote data source holding the trasactions data you wish to process.
 You can do this by inputing connection settings on the MySQL Source Configurations Page using the "Source Config" menu. 
 ...
 - Database Name: - The name of the database holding the trasactional data
